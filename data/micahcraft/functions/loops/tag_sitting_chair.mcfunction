...
execute store result score #UUID_0_Check Math run data get entity @e[tag=ChairChecking,limit=1] interaction.player[0]
execute store result score #UUID_1_Check Math run data get entity @e[tag=ChairChecking,limit=1] interaction.player[1]
execute store result score #UUID_2_Check Math run data get entity @e[tag=ChairChecking,limit=1] interaction.player[2]
execute store result score #UUID_3_Check Math run data get entity @e[tag=ChairChecking,limit=1] interaction.player[3]
...
execute unless score #UUID_Check Math matches 4 run function minecraft:loops/tag_sitting_chair
