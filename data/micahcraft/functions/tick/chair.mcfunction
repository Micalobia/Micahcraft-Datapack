...
execute as @e[tag=Box,tag=Chair] at @s positioned ~ ~0.5005 ~ unless entity @e[type=marker,tag=Chair,distance=..0.01] run kill @s
...
execute as @e[type=marker,tag=Chair,tag=!LookedAt] at @s positioned ~ ~-0.5005 ~ run kill @e[type=interaction,tag=Chair,tag=Box,distance=..0.01]
execute as @e[type=marker,tag=Chair,tag=LookedAt] at @s positioned ~ ~-0.5005 ~ unless entity @e[type=interaction,tag=Chair,distance=..0.01] run summon interaction ~ ~ ~ {Tags:["Chair","Box"],response:true,width:1.001f,height:1.001f}
...
execute as @e[type=interaction,tag=Chair,tag=Box] at @s on target positioned ~ ~0.5005 ~ run function micahcraft:tick/chair/ride