...
execute store result storage micahcraft:settings temp int 1 run scoreboard players get #PageKey mk.misc.player.id
scoreboard players add #PageKey mk.misc.player.id 1
...
scoreboard players operation #Value mk.math = #PageKey mk.misc.player.id
