...
execute unless score #Value mk.math matches 1 run tag @s add mk.trim_particles.show
...
execute unless score #Value mk.math matches 1 run tag @s add mk.trim_particles.show_self