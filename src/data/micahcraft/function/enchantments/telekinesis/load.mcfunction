...
scoreboard objectives add mk.telekinesis.used.netherite_pickaxe minecraft.used:minecraft.netherite_pickaxe
...
scoreboard objectives add mk.telekinesis.used.netherite_axe minecraft.used:minecraft.netherite_axe
...
scoreboard objectives add mk.telekinesis.used.netherite_shovel minecraft.used:minecraft.netherite_shovel
...
scoreboard objectives add mk.telekinesis.used.netherite_hoe minecraft.used:minecraft.netherite_hoe

scoreboard objectives add mk.telekinesis.used.shears minecraft.used:minecraft.shears